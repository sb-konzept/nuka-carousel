  ...
  _createClass(PreviousButton, [{
    ...
    value: function render() {
      return _react.default.createElement("button", {
        style: defaultButtonStyles(this.props.currentSlide === 0 && !this.props.wrapAround),
...
function (_React$Component2) {
  ...
  _createClass(NextButton, [{
    ...
    value: function render() {
      return _react.default.createElement("button", {
        style: defaultButtonStyles(this.props.currentSlide + this.props.slidesToScroll >= this.props.slideCount && !this.props.wrapAround),
        onClick: this.handleClick
      }, "NEXT");
    }
  }]);
